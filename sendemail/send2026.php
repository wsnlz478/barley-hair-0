...
$CONFIG = [
    ...
    // 咨询项目白名单（支持简体中文 + 英文 + Contact页面自定义值三版本，保证所有入口表单提交成功不漏单）
    'project_whitelist' => [
        // 简体中文值（由悬浮/侧边多语言表单radio value映射）
        '发际线种植','头发加密','秃顶植发','眉毛种植','胡须种植',
        '鬓角种植','体毛种植','脱发治疗','头发养护',
        // 英文标准值（与多语言表单en.label一致，兼容自定义英文表单）
        'Hairline','Density','Baldness','Eyebrow','Beard',
        'Sideburn','Body Hair','Hair Loss Treatment','Hair Care',
        // Contact页面独立表单option value（兜底，防止漏单）
        'hairline','thickening','baldness','eyebrow','beard',
        'sideburns','bodyhair','treatment','haircare'
    ]
];
